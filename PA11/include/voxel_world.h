...
struct VoxelWorld {
    ...
    static std::array<Chunk::ptr, WORLD_RADIUS * 2 + 2> generateChunksX(size_t X, size_t startZ);
    ...
    static std::array<Chunk::ptr, WORLD_RADIUS * 2 + 2> generateChunksZ(size_t startX, size_t Z);
};
